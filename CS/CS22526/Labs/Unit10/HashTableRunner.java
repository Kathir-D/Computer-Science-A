...
public class HashTableRunner {
  ...
  public static void main(String[] args) {
    try {
      CS.CS22526.Labs.Unit10.HashTable numberTable =
        new CS.CS22526.Labs.Unit10.HashTable();
      Scanner numIn = new Scanner(
        new File("CS/CS22526/Labs/Unit10/numbers.dat")
      );
      ...
      Scanner wordIn = new Scanner(
        new File("CS/CS22526/Labs/Unit10/words.dat")
      );
