...
public class Unit6a_StringFirstLetterRunner {
  ...
  public static void main(String args[]) {
    out.println(
      Unit6a_StringFirstLetterCheck.checkFirstLetter("hello", "howdy")
    );
    ...
    out.println(
      Unit6a_StringFirstLetterCheck.checkFirstLetter("State", "Champions")
    );
    out.println(Unit6a_StringFirstLetterCheck.checkFirstLetter("ABC", "DEF"));
    out.println(
      Unit6a_StringFirstLetterCheck.checkFirstLetter("Doug", "Doggies")
    );
  }
}
/*
