...
public class MonsterRunner {
  ...
  public static void main(String args[]) {
    ...
    String name1 = keyboard.hasNext() ? keyboard.next() : "A";
    out.print("Enter 1st monster's size : ");
    int size1 = keyboard.hasNextInt() ? keyboard.nextInt() : 10;
    out.print("Enter 2nd monster's name : ");
    String name2 = keyboard.hasNext() ? keyboard.next() : "B";
    out.print("Enter 2nd monster's size : ");
    int size2 = keyboard.hasNextInt() ? keyboard.nextInt() : 12;
