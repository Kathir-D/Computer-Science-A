...
public class Unit4b_StringStuff
{
	...
	public int diffInASCII( char Letter )
	{
 	...
 	public String toString() {
		return  "Enter a word :: " + word + "\n" +
				"Has first last letters :: " + getFirstLastLetters() + "\n" +
				"Has middle letter :: " + getMiddleLetter() + "\n" +
				"has same first and last letter :: " + sameFirstLastLetters() + "\n" +
				"Difference in ascii values " + word + " minus " + "C" + " == " + diffInASCII('c') + "\n";
	}
}
