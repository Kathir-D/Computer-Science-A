...
public class Unit8b_StringRemoverRunner {
  ...
  public static void main(String args[]) {
    Unit8b_StringRemover a = new Unit8b_StringRemover(
      "xR-MxR-MHelloxR-M",
      "R-M"
    );
    System.out.println(a.toString());
    Unit8b_StringRemover b = new Unit8b_StringRemover(
      "sxsssxssxsxssexssxsesss",
      "xs"
    );
    System.out.println(b.toString());
    Unit8b_StringRemover c = new Unit8b_StringRemover(
      "fuxqwexqwertyxqwexqwertyrtyxqwertyrtyn",
      "qwerty"
    );
    System.out.println(c.toString());
    Unit8b_StringRemover d = new Unit8b_StringRemover(
      "dogdogcatddodogdogdoggog",
      "dog"
    );
