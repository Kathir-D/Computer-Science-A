...
public class Unit9a_TwoToTenRunner
{
	public static void main ( String[] args )
	{
        ...
        System.out.println("10101010101 == " + Unit9a_TwoToTen.getBaseTen("10101010101"));
        System.out.println("1010101010110 == " + Unit9a_TwoToTen.getBaseTen("1010101010110"));
        System.out.println("111111111111111111 == " + Unit9a_TwoToTen.getBaseTen("111111111111111111"));
	}
}
